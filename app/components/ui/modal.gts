...
export default class UiModal extends Component<UiModalSignature> {<template>{{#in-element this.destinationElement insertBefore=null}}
  <div class="modal" {{didInsert this.didInsert}} {{willDestroy this.removeListeners}} ...attributes>
    <div class="modal-top">
      <button {{on "click" @toggleModal}} type="button" class="cool-button">
        X
      </button>
    </div>
    {{yield}}
