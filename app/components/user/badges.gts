...
import BadgeViewerContainer from "./badge-viewer-container.js";
...
export default class UserBadges extends Component<UserBadgesSignature> {<template><div class="mt-2">
  {{#each this.badges as |badge|}}
    <BadgeViewerContainer @badge={{badge}} />
  {{/each}}
</div>
</template>
