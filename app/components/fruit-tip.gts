...
import Fruit0 from "./fruit-tip/fruit.ts";
...
export default class FruitTipComponent extends Component {<template><div class="flex flex-wrap">
  {{#each this.fruitTypes as |fruit|}}
    <Fruit0 @fruitTip={{this.fruitTip}} @fruit={{fruit}} />
  {{/each}}
</div></template>
